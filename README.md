This is the README.md file of the **instructor** branch of the repository.

**WARNING:** student use of files in the **instructor** branch of the repository
may constitute a breach of the academic honor code and could result in
disciplinary action.
